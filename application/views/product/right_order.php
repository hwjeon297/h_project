...
<form action="right_payment" method="post">
...
<input type="hidden" name="orderproduct_qty" value="<?=$_GET['qty']?>">
   <div class="shopping-cart-reform">
      <div class="item">
        <div class="image">
          <img src="<?=$item['product_m_image']?>" alt="" style="width:110px"/>
        </div>
...
<div class="container">
  <div class="form-part">
    ...
    <div class="form-inputs">
      ...
      <button value="button" onclick="javascript:addcheck()" style="width: "></button>
